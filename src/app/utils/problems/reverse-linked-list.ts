...
//--- JS doesn't have a build LinkedList class, so we'll create one
class LinkedList {
  value: number;
...
//--- Return an array of values from linked list
...
//--- Check if the code of user is correct or not
...
//--- Code for user start code from it
